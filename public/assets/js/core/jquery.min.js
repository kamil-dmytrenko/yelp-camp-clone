/*! jQuery v3.2.1 | (c) JS Foundation and other contributors | jquery.org/license */ !(function(a, b) {
  ...
  r.fn = r.prototype = {
    ...
    map: function(a, b, c) {
      ...
      if (w(a))
        ...
        for (f in a) e = b(a[f], f, c), e != null && h.push(e);
      return g.apply([], h);
    },
    guid: 1,
    proxy: function(a, b) {
      var c, d, e;
      if (typeof b === 'string' && (c = a[b], b = a, a = c), r.isFunction(a)) return d = f.call(arguments, 2), e = function() {
          ...
          return d === 1 && e === 0 ? function(a) {
            ...
            if (q) {
              ...
              if (o = [g ? q.firstChild : q.lastChild], g && s) {
                ...
                while (m = ++n && m && m[p] || (t = n = 0) || o.pop())
                  if ((h ? m.nodeName.toLowerCase() === r : m.nodeType === 1) && ++t && (s && (l = m[u] || (m[u] = {}), k = l[m.uniqueID] || (l[m.uniqueID] = {}), k[a] = [w, t]), m === b)) break;
      ...
      pseudos: {
        ...
        lang: ia(function(a) {
          ...
          function(b) {
            var c;
            do
              if (c = p ? b.lang : b.getAttribute('xml:lang') || b.getAttribute('lang')) return c = c.toLowerCase(), c === a || c.indexOf(a + '-') === 0; while ((b = b.parentNode) && b.nodeType === 1);
            return !1;
          };
        }),
        target: function(b) {
  ...
  r.fn.extend({
    ...
    attr: function(a, b, c) {
      ...
      if (f !== 3 && f !== 8 && f !== 2) return typeof a.getAttribute === 'undefined' ? r.prop(a, b, c) : (f === 1 && r.isXMLDoc(a) || (e = r.attrHooks[b.toLowerCase()] || (r.expr.match.bool.test(b) ? lb : void 0)), void 0 !== c ? c === null ? void r.removeAttr(a, b) : e && 'set' in e && void 0 !== (d = e.set(a, c, b)) ? d : (a.setAttribute(b, c + ''), c) : e && 'get' in e && (d = e.get(a, b)) !== null ? d : (d = r.find.attr(a, b),
      d == null ? void 0 : d));
    },
    attrHooks: {
      type: {
